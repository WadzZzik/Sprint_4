...
public class MainPage {
    ...
    //Метод для ожидания загрузки элемента дропдауна
    public void waitForLoadItem(int index) {
        final WebElement webElement = new WebDriverWait(this.webDriver, Duration.ofSeconds(3))
